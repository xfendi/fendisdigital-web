...
const Login = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-neutral-950 !text-white w-screen h-screen">
      <form onSubmit={handleLogin} className="flex flex-col gap-5 w-full px-5 md:w-max">
        <div
        ...
        <p className="text-neutral-300 text-sm text-center">Nie masz jeszcze konta? <Link to="/register" className="text-white transition-all duration-300 hover:text-blue-500" >Zarejestruj się</Link></p>
      </form>
    </div>
  );
};
